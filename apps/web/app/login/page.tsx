                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative group/disabled w-full cursor-not-allowed" title="Feature Disabled">
                            <button
                                type="button"
                                disabled
                                className="w-full flex items-center justify-center gap-3 bg-gray-50 border border-gray-200 text-slate-400 py-3 px-4 rounded-lg font-semibold shadow-none opacity-60 grayscale cursor-not-allowed pointer-events-none select-none"
                            >
                                <svg className="w-5 h-5 opacity-60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="relative group/disabled w-full cursor-not-allowed" title="Feature Disabled">
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 bg-gray-50 border border-gray-200 text-slate-400 py-3 px-4 rounded-lg font-semibold shadow-none opacity-60 grayscale cursor-not-allowed pointer-events-none select-none"
                            >
                                <svg className="w-5 h-5 text-slate-400 opacity-60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {activeTab === 'home' ? (
                        <div className="space-y-4 transition-opacity duration-500 ease-in-out">
                            <div>
                                ...
                                <p className="text-white/60 font-mono text-sm tracking-wide mt-2 flex items-center gap-2">
                                    <span>/ˈtaɪ.ɡɑː/</span>
                                    <span className="text-white/30">•</span>
                                    <span className="text-white/50 text-xs font-sans tracking-normal italic">like &quot;ti&quot; in tiger + &quot;gha&quot; in ghana</span>
                                </p>
                            </div>
