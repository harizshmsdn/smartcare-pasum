...
// Style objects declared outside the component to prevent re-creation on every render
...
export default function Login() {
  ...
  // Once AppContext detects a session (from either path below) and finishes
  // loading the student's profile, `user` becomes truthy — send them in.
  useEffect(() => {
  ...
  async function handleLogin(e) {
    ...
    // On success, AppContext's onAuthStateChange picks up the session and
    // the useEffect above handles navigation once the profile is loaded.
  }
  ...
  async function handleSocialLogin(provider) {
    ...
    // Supabase redirects away and back for OAuth; on return, AppContext
    // detects the session and the useEffect above navigates to /home.
  }
  ...
  return (
    <div
      style={{
        ...
        justifyContent: 'center', // Fixed from 'justify'
        alignItems: 'center',
        minHeight: '100vh',
